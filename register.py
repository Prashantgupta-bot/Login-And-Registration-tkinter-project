...
class Register:
    def __init__(self, root):
        ...
        # BG Image
        self.bg = ImageTk.PhotoImage(file="images/b2.jpg.jpg")
        ...
        title = Label(frame1, text="REGISTER HERE", font=("times in roman", 20, "bold"),
                      bg="white", fg="green").place(x=50, y=30)

        f_name = Label(frame1, text="First Name", font=("times in roman", 15, "bold"), bg="white",
        ...
        l_name = Label(frame1, text="Last Name", font=("times in roman", 15, "bold"), bg="white", fg="gray").place(x=370, y=100)
        self.txt_l_name = Entry(frame1, font=("times in roman", 15), bg="lightgray")
        ...
        question = Label(frame1, text="Security Question", font=("times in roman", 15, "bold"), bg="white", fg="gray").place(x=50, y=240)
        self.cmb_quest = ttk.Combobox(frame1, font=("times in roman", 13),state="readonly", justify=CENTER)
        self.cmb_quest["values"]=("Select","Your First Pet Name ?","Your Birth Place ?","Your Best Friend Name ?")
        self.cmb_quest.place(x=50, y=270, width=250)
        self.cmb_quest.current(0)

        answer = Label(frame1, text="Answer", font=("times in roman", 15, "bold"), bg="white", fg="gray").place(x=370, y=240)
        ...
        # login button
        self.btn_imgs = ImageTk.PhotoImage(file="images/login.jpg")
        btn_login = Button(self.root, image=self.btn_imgs, bd=0, cursor="hand2",command=self.login_window).place(x=210, y=520)
    ...
    def register_data(self):
        if self.txt_f_name.get() == "" or self.txt_email.get() == "" or self.cmb_quest.get() == "Select" or self.txt_answer.get() == "" or self.txt_contact.get() == "":
            ...
            try:
                ...
                s =   "INSERT INTO registration(f_name,l_name,Contact_no,Email,security_que,Answer,Passwords) VALUES (%s, %s, %s, %s,%s,%s,%s)"
