...
class Login:
    ...
    def __init__(self,root):
        ...
        title = Label(frame1, text="Login Here", font=("times in roman", 20, "bold"), bg="red", fg="black").place(
            x=50, y=30,width=800)
    ...
    def login_data(self):
            if self.txt_username.get()=="" or self.txt_password.get()=="" or self.cmb_quests.get()=="" or self.txt_answers.get()=="":
                ...
                try:
                    ...
                    s = "SELECT * FROM registration  WHERE Email=%s AND Passwords=%s "
                    ...
                    if row ==None:
                        ...
                        messagebox.showinfo("Congratulations", "Login Successful", parent=self.root)
                    cur.close()
